          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/pilla-manikanta-47b876259?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank" rel="noopener noreferrer" className="bg-navy-900 text-white p-3 rounded-full hover:bg-gold-600 transition-colors duration-300">
                  <Linkedin size={20} />
                </a>
                <a href="https://github.com/Manikanta-Pilla" target="_blank" rel="noopener noreferrer" className="bg-navy-900 text-white p-3 rounded-full hover:bg-gold-600 transition-colors duration-300">
                  <Github size={20} />
                </a>
              </div>
            </div>
