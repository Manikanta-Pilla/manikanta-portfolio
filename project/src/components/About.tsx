          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-slate-600 leading-relaxed font-serif">
                I'm Mani Kanta, a passionate UI/UX designer and frontend developer with expertise in 
              ...
              <div className="grid grid-cols-3 gap-8 pt-8">
                <div className="text-center">
                  ...
                  <h4 className="text-2xl font-bold text-navy-900">50+</h4>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-2xl font-bold text-navy-900">100%</h4>
