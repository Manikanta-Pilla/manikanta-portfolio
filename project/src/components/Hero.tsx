          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-5xl md:text-7xl font-bold text-navy-900 mb-6 leading-tight">
                UI/UX
                <span className="block text-gold-500">Designer</span>
                & Developer
              </h1>
              
              <p className="text-xl md:text-2xl text-slate-600 mb-8 max-w-2xl leading-relaxed font-serif">
                Passionate about creating intuitive digital experiences that bridge the gap between 
                beautiful design and functional development.
              </p>
